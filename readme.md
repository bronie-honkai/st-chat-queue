...
| **📋 粘贴楼层** | 点击底部按钮，粘贴已复制的楼层（包括文本和附件）。先复制楼层，再粘贴到其他位置。 |

### 3. 管理楼层 (Item Controls)
每个楼层项右侧都有多个功能强大的微型按钮，鼠标悬停可查看提示：
...
#### 功能改进
*   **🔄 复制粘贴楼层功能升级** - 支持完整楼层复制粘贴（包括附件）
    *   **复制按钮** 现在复制整个楼层对象（文本 + 附件）到内存
    *   **粘贴楼层** 现在可以粘贴完整的楼层副本，包括所有附件
    *   使用内存存储，无需依赖剪贴板，更加可靠稳定
    *   完整的楼层快速复制，高效构建队列

#### 改进
*   增强了楼层复制粘贴的功能性，支持批量快速复制相同格式的楼层
*   优化工作流，快速复制已有楼层的所有内容
